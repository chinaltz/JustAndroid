...
//---------------------------支付宝支付参数---------------------//
    ...
    //    public static final String BASEURL = "http://192.168.64.54:3001/";
   //    public static final String BASEURL = "http://192.168.1.123:3001/";
         public static final String BASEURL="https://op.dh-etc.com/";
//       public static final String BASEURL="http://192.168.1.123:3101/";
//    public static final String BASEURL="http://192.168.1.123:3101/";
//         public static final String BASEURL="http://192.168.1.119:80/";
//        public static final String BASEURL = "http://192.168.1.106:3001/";
//        public static final String BASEURL = "http://192.168.65.42:3101/";
//        public static final String BASEURL = "http://192.168.65.42:3101/";
//    public static final String BASEURL = "http://202.102.79.144:3101/";

    //图片地址
    public static final String BASEURLIMAGE = Constants.BASEURL + "fileApi/showFile?fileId=";

    //检查更新
    public static final String BASEURLDOWN = Constants.BASEURL + "fileApi/download?fileId=";
