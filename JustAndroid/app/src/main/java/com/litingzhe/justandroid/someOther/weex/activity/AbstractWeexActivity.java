...
import com.litingzhe.justandroid.someOther.weex.delegate.ScreenUtil;
import com.litingzhe.justandroid.someOther.weex.delegate.WXAnalyzerDelegate;
 ...
 */
public abstract class AbstractWeexActivity extends AutoLayoutActivity implements IWXRenderListener {
...
//    AssertUtil.throwIfNull(mContainer,new RuntimeException("Can't render page, container is null"));
  ...
  protected void renderPageByURL(String url, Map<String, Object> options){
    renderPageByURL(url,options,null);
  }

  protected void renderPageByURL(String url, Map<String, Object> options, String jsonInitData){
//    AssertUtil.throwIfNull(mContainer,new RuntimeException("Can't render page, container is null"));
