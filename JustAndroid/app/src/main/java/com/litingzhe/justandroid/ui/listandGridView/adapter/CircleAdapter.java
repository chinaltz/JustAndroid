...
import com.litingzhe.justandroid.ui.listandGridView.adapter.viewholder.CircleViewHolder;
import com.litingzhe.justandroid.ui.listandGridView.adapter.viewholder.ImageViewHolder;
import com.litingzhe.justandroid.ui.listandGridView.adapter.viewholder.URLViewHolder;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.model.ActionItem;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.model.CircleItem;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.model.CommentItem;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.model.FavortItem;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.model.PhotoInfo;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.utils.DatasUtil;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.utils.GlideCircleTransform;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.utils.UrlUtils;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.widgets.CommentListView;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.widgets.ExpandTextView;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.widgets.MultiImageView;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.widgets.PraiseListView;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.widgets.SnsPopupWindow;
import com.litingzhe.justandroid.ui.listandGridView.wechatCircle.widgets.dialog.CommentDialog;
...
//                                    }
//                                    ImagePagerActivity.startImagePagerActivity(((WeexActivity) context), photoUrls, position, imageSize);
                ...
                case 0://点赞、取消点赞
                    ...
                    FavortItem item = DatasUtil.createCurUserFavortItem();
                        ...
                        if ("赞".equals(actionitem.mTitle.toString())) {
                            CircleItem circleItem  = (CircleItem) getDatas().get(mCirclePosition);
                            circleItem.getFavorters().add(item);
                            notifyDataSetChanged();
                        } else {//取消点赞
                            CircleItem circleItem = (CircleItem) getDatas().get(mCirclePosition);
                            List<FavortItem> items = circleItem.getFavorters();
