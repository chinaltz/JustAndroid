...
public class AMapNavBaseActivity extends Activity implements AMapNaviListener, AMapNaviViewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStartLatlng=bundle.getParcelable("beginLatlng");
        mEndLatlng=bundle.getParcelable("endlatlng");

        if (mStartLatlng==null||mEndLatlng==null){

            AbToastUtil.showToast(mContext,"起始点不能为空，导航失败");
