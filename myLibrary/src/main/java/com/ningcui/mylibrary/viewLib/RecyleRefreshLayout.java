 ...
 */
public class RecyleRefreshLayout extends SwipeRefreshLayout {
    ...
    public RecyleRefreshLayout(Context context) {
        this(context, null);
    }

    public RecyleRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    public void setAdapter(@NonNull RecyclerView recyclerView, @NonNull RecyleRefreshLayout.Adapter mAdapter) {
        adapter = mAdapter;
    ...
    public static abstract class Adapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == -99) {
                return new RecyclerView.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.view_swipeview_footer, parent, false)) {
                };
            } else {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (getItemViewType(position) == -99) {
                ProgressBar progressBar = (ProgressBar) holder.itemView.findViewById(R.id.swipe_footer_progress);
                TextView textView = (TextView) holder.itemView.findViewById(R.id.swipe_footer_tv);
                if (state == STATE_END) {
